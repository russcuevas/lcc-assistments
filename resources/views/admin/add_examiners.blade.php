                            ...
                            <form id="add_default_id_validation" method="POST" action="">
                                <div class="form-group form-float" style="margin-top: 20px !important;">
                                    <div class="form-line">
                                        ...
                                        <input style="background-color: gray;" type="text" class="form-control" name="default_id" value="20251002-01" placeholder="20251002-01" readonly>
                                ...
                                <a href="{{ route('admin.examiners.page') }}" class="btn btn-warning waves-effect">GO BACK</a>
